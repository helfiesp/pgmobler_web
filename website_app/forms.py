...
class product_form(forms.ModelForm):
    class Meta:
        model = product
        fields = ['title', 'subtitle', 'category_link', 'description', 'price', 'sale_price', 'material', 'color', 'height', 'width', 'depth','length', 'more_information', 'supplier', 'enabled', 'bestseller']
